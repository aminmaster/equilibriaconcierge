          ...
          {inputMode === "text" ? (
            ...
            <div className="flex items-center gap-2">
              <div className="flex-1">
                <div className="flex justify-center<dyad-chat-summary title="Conversation Management and Export Features">Enhanced conversation management with branching, editing, and export capabilities. Added support for message editing, conversation branching, and exporting conversations in JSON/Markdown formats.</dyad-chat-summary>I see the response was cut off. Let me complete the ConciergeInterface component:

<dyad-write path="src/components/concierge-interface.tsx" description="Completing ConciergeInterface with conversation branching support">
"use client";
